  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              {logoPreview || logoPath ? (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 p-4 border-2 border-dashed border-border rounded-lg hover:border-orange-300 dark:border-orange-900/50 hover:bg-white/[0.02] transition-colors"
                >
        ...
        <div className="space-y-1.5">
          <div className="flex items-center gap-3">
            <input
              ...
              className="h-4 w-4 cursor-pointer rounded accent-orange-500 disabled:cursor-not-allowed"
            />
        ...
        {uploadingLogo ? (
          <Button disabled className="bg-orange-600 text-white">
          ...
          <Button
            ...
            className="bg-orange-600 text-white hover:from-orange-400 hover:to-orange-400 disabled:opacity-50"
          >
