...
const TAG_STYLE: Record<TagType, { bg: string; text: string }> = {
  Feature:     { bg: 'bg-orange-600/15 border border-orange-300 dark:border-orange-900/50', text: 'text-orange-400' },
  Improvement: { bg: 'bg-orange-600/15 border border-orange-300 dark:border-orange-900/50', text: 'text-orange-400' },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-12 px-4 text-center">
        <p className="text-xs font-semibold uppercase tracking-widest text-orange-500 mb-4">Changelog</p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <div className="relative">
            {/* Vertical line */}
            <div className="absolute left-[7px] top-3 bottom-3 w-px bg-gradient-to-b from-orange-500/40 via-border to-transparent hidden sm:block" />
              ...
              {RELEASES.map((release) => {
                ...
                return (
                  <article key={release.version} className="sm:pl-8 relative">
                    {/* Timeline dot */}
                    <div className="absolute left-0 top-1 h-3.5 w-3.5 rounded-full bg-orange-600/30 border border-orange-500/60 hidden sm:block" />
