...
import { INDEX_FOLLOW_ROBOTS, NOINDEX_NOFOLLOW_ROBOTS } from '@/lib/seo/robots';
...
export async function generateMetadata(props: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  const siteUrl = `${process.env.NEXT_PUBLIC_APP_URL ?? 'https://webanalyzer.app'}/share/${params.id}`;
